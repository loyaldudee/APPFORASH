...
const App = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      const response = await fetch('http://192.168.24.254:3000/user/register', {
        method: 'POST',
        headers: {
  ...
  const handleGettingRole = async ()=>{
    try {
      const response = await fetch('http://192.168.24.254:3000/user/getuser', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleLogin = async () => {
    try {
      const response = await fetch('http://192.168.24.254:3000/user/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleVerifyOTP = async () => {
    try {
      const response = await fetch('http://192.168.24.254:3000/user/verify', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
